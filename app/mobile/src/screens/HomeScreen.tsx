    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title} accessibilityRole="header">AidNexus</Text>
        ...
        <View style={styles.heroSection}>
          ...
          <Text style={styles.description}>
            AidNexus utilizes the Stellar network and Soroban smart contracts to
        ...
        <View style={styles.walletCard}>
          ...
          <Text style={styles.walletDescription}>
            Connect a compatible Stellar wallet with WalletConnect v2. AidNexus
      ...
      <TouchableOpacity
        ...
        accessibilityHint="Opens the camera to scan an AidNexus QR code"
      >
