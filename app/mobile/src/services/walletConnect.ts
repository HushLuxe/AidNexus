...
const APP_SCHEME = 'aidnexus';
const DEFAULT_APP_URL = 'https://github.com/HushLuxe/AidNexus';
const DEFAULT_ICON = 'https://raw.githubusercontent.com/HushLuxe/AidNexus/main/app/mobile/assets/icon.png';
...
const getAppMetadata = () => ({
  name: 'AidNexus Mobile',
  description: 'AidNexus mobile wallet connection for transparent aid delivery on Stellar.',
  url: DEFAULT_APP_URL,
  icons: [DEFAULT_ICON],
  redirect: {
