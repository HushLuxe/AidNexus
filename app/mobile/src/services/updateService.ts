...
const VERSION_CONFIG_URL = 'https://api.aidnexus.org/mobile/version';
  ...
  try {
    ...
    */
    ...
    return {
      ...
      storeUrl: {
        ios: 'https://apps.apple.com/app/aidnexus',
        android: 'https://play.google.com/store/apps/details?id=org.aidnexus.mobile',
      },
    };
  } catch (error) {
