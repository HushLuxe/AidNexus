...
export function ForceUpgradeScreen({ onRetry }: ForceUpgradeScreenProps) {
  ...
  const handleUpdateApp = () => {
    ...
    window.open('https://aidnexus.app/download', '_blank');
  };
      ...
      <div className="relative w-full max-w-lg">
        <div className="text-center">
          ...
          <p className="mb-8 text-lg text-slate-300">
            A newer version of AidNexus is required before you can continue using the application.
          </p>
          ...
          <div className="mt-8 space-y-2 text-sm text-slate-400">
            ...
            <p className="text-xs">
              ...
              <a
                href="https://aidnexus.app/support"
                target="_blank"
