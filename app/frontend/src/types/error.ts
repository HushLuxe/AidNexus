...
export const ERROR_METADATA: Record<ErrorCategory, ErrorMetadata> = {
  wallet: {
    ...
    hints: [
      ...
      'Verify you have granted permission to AidNexus'
    ],
  ...
  server: {
    ...
    hints: [
      ...
      'Check the AidNexus status page for updates'
    ],
  ...
  config: {
    ...
    hints: [
      'Set NEXT_PUBLIC_API_URL to the full backend URL (e.g. https://api.aidnexus.org)',
