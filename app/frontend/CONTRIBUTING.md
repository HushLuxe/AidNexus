# Contributing to AidNexus Frontend

Thank you for your interest in contributing to the AidNexus frontend! This document covers the development workflow, code standards, and conventions for submitting changes.
...
1. **Fork and clone** the repository:
   ```bash
   git clone https://github.com/YOUR_USERNAME/aidnexus.git
   cd aidnexus
   ```
...
- **Questions**: Open a [GitHub Discussion](https://github.com/your-org/aidnexus/discussions)
- **Bugs**: Open a [GitHub Issue](https://github.com/your-org/aidnexus/issues) with steps to reproduce
